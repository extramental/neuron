# Code adapted from https://github.com/Operational-Transformation/ot.py/
...
# Code to facilitate serializing edits over the wire and computing diffs.

def make_text_operations(orig, new):
    """
